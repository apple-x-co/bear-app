...
## Detected Issues
- カーディナリティの低い列にインデックスが設定されています。これは非効率的なスキャンの原因となる可能性があります。 [Learn more](https://koriym.github.io/Koriym.SqlQuality/issues/LowCardinalityIndex)
