...
-> Filter: (email_queue_recipients.email_queue_id = 0)  (cost=0.35 rows=1) (actual time=0.003..0.003 rows=0 loops=1)
    -> Index lookup on email_queue_recipients using fk_email_queue_recipients_1 (email_queue_id=0) (reverse)  (cost=0.35 rows=1) (actual time=0.0025..0.0025 rows=0 loops=1)
