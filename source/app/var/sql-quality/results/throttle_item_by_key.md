...
### EXPLAIN ANALYZE
-> Filter: (throttles.expire_date >= <cache>(now()))  (cost=0.283 rows=0.333) (actual time=0.00558..0.00558 rows=0 loops=1)
    -> Index lookup on throttles using idx_throttles_1 (throttle_key='test-key')  (cost=0.283 rows=1) (actual time=0.005..0.005 rows=0 loops=1)
